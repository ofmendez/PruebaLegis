...
namespace MaterialUI {
    public class ToastAnim : MonoBehaviour {
        ...
        void Start() {
            ...
            onPos = new Vector2(0, 1);
            offPos = new Vector2(0, -80);
        ...
        void Update() {
            if (state == 1) {
                if (thisRect.position.y < onPos.y) {
                    ...
                    tempVec2.y = Mathf.Lerp(tempVec2.y, onPos.y + 2, Time.deltaTime * animSpeed);
                ...
                if (thisRect.position.y > offPos.y) {
                    tempVec2 = thisRect.position;
                    tempVec2.y = Mathf.Lerp(tempVec2.y, offPos.y - 2, Time.deltaTime * animSpeed);
                    thisRect.position = tempVec2;
